...
إذا كانت أداة المحادثة التي تستخدمها تفهم [WebMCP](/ar/docs/webmcp/) بدلاً من ذلك، فيمكنها الاستغناء عن كل هذا النسخ واللصق وقراءة إعدادك والتحقق منه وكتابته مباشرة.
