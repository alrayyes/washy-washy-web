...
Если ваш чат-инструмент вместо этого понимает
[WebMCP](/ru/docs/webmcp/), он может обойтись без всего этого
копирования-вставки и читать, проверять и записывать вашу конфигурацию
напрямую.
